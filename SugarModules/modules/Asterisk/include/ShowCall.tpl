<div class="asterisk_info" id="<?php print $item['asterisk_id']; ?>">
	...
	<table class="asterisk_data">
		...
		<td>
		    <?php if (isset($item['full_name']) && !empty($item['full_name'])) { ?>
		    ...
		    <?php } else { ?>
		    <a href="index.php?module=Contacts&action=EditView&phone_work=<?php print $item['phone_number']; ?>">
			<?php print $mod_strings['CREATE_CONTACT']; ?>
		    </a>
		    <?php } ?>
		</td>
	    </tr>
