...
$asterisk_config['asterisk_host'] = '10.0.0.1';
$asterisk_config['asterisk_port'] = '5038';
$asterisk_config['asterisk_user'] = 'admin';
$asterisk_config['asterisk_secret'] = 'elastix456';
$asterisk_config['asterisk_prefix'] = '';
$asterisk_config['asterisk_context'] = 'from-internal';
$asterisk_config['asterisk_expr'] = '^sip/[1-9][0-9][0-9][0-9]?-';
$asterisk_config['asterisk_soapuser'] = 'admin';
$asterisk_config['asterisk_recordings'] = '/var/spool/asterisk/monitor';
...
$focus->config_categories[] = 'asterisk';
...
$sugar_smarty->assign('config', /*$configurator->config*/$focus->settings);
