 ...
 * Updates for Asterisk 1.8, SugarCRM v6.2+, call record downloads and service persistence
 *
...
$manifest = array(
    ...
    'key' => '',
    'author' => 'KINAMU Business Solutions AG / abcona active business consulting',
    'description' => 'Integrates Asterisk telephony features into SugarCRM.',
    'icon' => '',
    'is_uninstallable' => true,
    'name' => 'Asterisk SugarCRM Connector',
    'published_date' => '2011-08-24',
    'type' => 'module',
    'version' => '1.2 for v6.2',
...
$installdefs = array(
	...
	array(
	    'from' => '<basepath>/SugarModules/modules/Employees/metadata/detailviewdefs.php',
	    'to' => 'custom/modules/Employees/metadata/detailviewdefs.php',
	),
	array(
	...
	array(
	    'from' => '<basepath>/SugarModules/include/javascript',
